...
int main()
{
	...
	Symbol::InitTable({
		...
		NonTerminal::Pair("nt_global_statements"),
		NonTerminal::Pair("nt_global_statement"),
	...
	Rule::InitVector({
		...
		Rule::SharedPtr("nt_statement", {"nt_for"}),
		Rule::SharedPtr("nt_statement", {"nt_repeat"}),
		...
		Rule::SharedPtr("nt_global_statements", {"nt_global_statements", "nt_global_statement"}),
		Rule::SharedPtr("nt_global_statements", {"nt_global_statement"}),
		Rule::SharedPtr("nt_global_statement", {"nt_function_declare"}),  
		Rule::SharedPtr("nt_global_statement", {"nt_function_define"}),  
		Rule::SharedPtr("nt_global_statement", {"nt_function_call"}),  
