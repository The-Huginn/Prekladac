...
typedef enum {
    P_VOID, P_COMMA, P_E, P_LEFT, P_RIGHT, P_LEN, P_NOT, P_MUL, P_DIV, P_INT_DIV, P_PLUS, P_MINUS, P_CONCAT, P_GRT, P_LESS, P_GEQ, P_LEQ, P_EQ, P_NEQ, P_AND, P_OR, P_I, P_$, P_BINARY_OPERATOR, P_UNARY_OPERATOR
    }PrecedenceItemType;
