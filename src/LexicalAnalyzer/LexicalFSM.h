...
typedef enum {START, LOAD_ID, LOAD_INT_INT_PART, POINT, EXPONENT, SIGN, EXP_PART, LOAD_STRING, STRING_FINALIZE, ESC_SEQ, LIMIT_2, LIMIT_5, NORMAL_1, NORMAL_2,
    ...
    ERROR_STATE, EOF_STATE, F_ID, F_INTEGER, F_NUMBER, F_STRING, F_MINUS, F_PLUS, F_MUL, F_DIV, F_INT_DIV, F_DEF, F_COMMA, F_LEN, F_LEFT, F_RIGHT, F_LESS, F_LEQ, F_GRT, F_GEQ, F_CONCAT, F_ASS, F_EQ, F_NEQ,
    }LexicalType;
